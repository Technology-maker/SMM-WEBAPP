        ...
        <div className="min-h-screen flex items-center justify-center bg-[#050508] px-4 relative overflow-hidden">
            ...
            <div style={{
                ...
                <style>{`
                    ...
                    .fp-btn:hover:not(:disabled) { transform: translateY(-1px); box-shadow: 0 8px 30px rgba(124,58,237,0.45); }
                    .fp-btn:active:not(:disabled) { transform: translateY(0px); }
                    .fp-btn { transition: transform 0.2s ease, box-shadow 0.2s ease; }
                `}</style>
