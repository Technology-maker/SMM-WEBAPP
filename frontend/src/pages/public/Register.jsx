...
import { UserPlus, Mail, Lock, User, Zap, ArrowLeft, Eye, EyeOff } from "lucide-react";
...
const Register = () => {
  ...
  const fields = [
    { icon: User, type: "text", placeholder: "Full name", key: "name", extra: { autoComplete: "name" } },
    { icon: Mail, type: "email", placeholder: "Email address", key: "email", extra: { autoComplete: "email" } },
    { icon: Lock, type: "password", placeholder: "Password (min 6)", key: "password", extra: { minLength: 6, autoComplete: "new-password" } },
  ];
  ...
  return (
    <>
      ...
      >
        {/* Ambient blobs */}
        <div
          className="pointer-events-none absolute -top-32 -right-32 w-[420px] h-[420px] rounded-full opacity-20 blur-[100px]"
          style={{ background: "radial-gradient(circle, #7c3aed, transparent 70%)" }}
        />
        <div
          className="pointer-events-none absolute -bottom-32 -left-20 w-[360px] h-[360px] rounded-full opacity-15 blur-[100px]"
        ...
        >
          ...
          <p className="text-sm text-slate-500 mb-6">Start growing your social media today</p>

          {/* Form */}
          <form onSubmit={submit} className="space-y-4">
            {fields.map(({ icon: Icon, type, placeholder, key, extra }) => (
